...
| `SAFE_HUMAN_TAKEOVER`| Core Feature | Active & Verified | [HumanTakeoverManager.js](file:///d:/Projects/agents/src/domain/safety/HumanTakeoverManager.js) | Anti-interference human agent takeover suppressing bot replies when owner speaks |
