  ...
  async connect() {
    ...
    this.sock.ev.on('connection.update', (update) => {
      ...
      if (connection === 'close') {
        ...
        if (shouldReconnect && this.reconnectAttempts < this.maxReconnectAttempts) {
          ...
          console.error('[BaileysWhatsAppClient] Session logged out. Please clear session folder and restart to generate a new QR.');
        }
    ...
    this.sock.ev.on('messages.upsert', async ({ messages, type }) => {
      ...
      for (const msg of messages) {
        ...
        // Skip messages generated by this bot instance
